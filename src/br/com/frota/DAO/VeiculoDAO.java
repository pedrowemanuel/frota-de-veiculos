    ...
    public Veiculo selectVeiculo(int id) {
        ...
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_BY_ID)) {
            ...
            while (rs.next()) {
                ...
                String descricao_marca = rs.getString(id_marca, "descricao_marca");

                entidade = new Veiculo(id, descricao, new Marca(descricao_marca));
            }
        } catch (SQLException e) {
            printSQLException(e);
        } catch (ClassNotFoundException e) {
    ...
    public List<Veiculo> selectAllVeiculos() {
        ...
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_ALL)) {
            ...
            while (rs.next()) {
                ...
                entidades.add(new Veiculo(id, descricao, new Marca(descricao_marca)));
            }
        } catch (SQLException e) {
            printSQLException(e);
        } catch (ClassNotFoundException e) {
