    ...
    public MedicaoBandaVistoria selectMedicaoBandaVistoria(int id) {
        ...
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_BY_ID)) {
            ...
            while (rs.next()) {
                ...
                int idPneuBanda = rs.getPneuBanda("id_pneu_banda");
                int idMedicaoVistoria = rs.getMedicaoVistoria("id_medicao_vistoria");
                entidade = new MedicaoBandaVistoria(id, valor, new PneuBanda(idPneuBanda), new MedicaoVistoria(idMedicaoVistoria));
            }
        } catch (SQLException e) {
            printSQLException(e);
        } catch (ClassNotFoundException e) {
    ...
    public List<MedicaoBandaVistoria> selectAllMedicaoBandaVistorias() {
        ...
        try (PreparedStatement preparedStatement = prapararSQL(SELECT_ALL)) {
            ...
            while (rs.next()) {
                ...
                int idPneuBanda = rs.getPneuBanda("id_pneu_banda");
                int idMedicaoVistoria = rs.getMedicaoVistoria("id_medicao_vistoria");
                entidades.add(new MedicaoBandaVistoria(id, valor, new PneuBanda(idPneuBanda), new MedicaoVistoria(idMedicaoVistoria)));
            }
        } catch (SQLException e) {
            printSQLException(e);
        } catch (ClassNotFoundException e) {
